...
import { Form, Input, InputNumber, Button, Card, Typography, message, Select, Upload, Space } from 'antd';
    ...
    const onFinish = async (values) => {
        try {
            ...
            if (isEditing) {
                ...
                newProduct = await productService.createProduct(values);
                message.success('Product created successfully');
                // Store the new product in local storage for ProductList to access
